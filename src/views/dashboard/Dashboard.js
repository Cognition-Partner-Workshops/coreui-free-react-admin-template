...
const Dashboard = () => {
  ...
  return (
    <Box>
            ...
            {progressExample.map((item, index) => (
              ...
              >
                ...
                <LinearProgress
                  variant="determinate"
                  value={item.percent}
                  color={item.color === 'danger' ? 'error' : item.color}
      ...
      <WidgetsBrand sx={{ mb: 4 }} withCharts />
              ...
              <TableBody>
                {tableExample.map((item, index) => (
                  <TableRow key={index} hover>
                    <TableCell align="center">
                      <Avatar
                        ...
                        sx={{
                          ...
                          height: 40,
                          border: 2,
                          borderColor: colorMap[item.avatar.status] || 'grey.500',
                        }}
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell align="center">
                      <FlagIcon titleAccess={item.country.name} />
                    </TableCell>
                    <TableCell>
                      ...
                      <LinearProgress
                        ...
                        color={item.usage.color === 'danger' ? 'error' : item.usage.color}
                        sx={{ height: 4, borderRadius: 2 }}
                      />
                    </TableCell>
                    <TableCell align="center">
                      <CreditCardIcon titleAccess={item.payment.name} />
                    </TableCell>
                    <TableCell>
                      <Typography variant="caption" color="text.secondary">
                        Last login
