...
const generateDataset = () => Array.from({ length: 15 }, () => random(40, 100))
const chartData = {
  danger: generateDataset(),
  primary: generateDataset(),
  success: generateDataset(),
  dangerLine: generateDataset(),
  successLine: generateDataset(),
  infoLine: generateDataset(),
}
