            ...
            {progressExample.map((item, index) => (
              <Grid
                size={{
                  xs: 12,
                  sm: 6,
                  lg: index === progressExample.length - 1 ? 12 : 3,
                  xl: true,
                }}
                key={index}
                sx={{
                  display: {
                    xs: index === progressExample.length - 1 ? 'none' : 'block',
                    xl: 'block',
                  },
                }}
              >
              ...
              <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid size={6}>
                      <Box sx={{ borderLeft: 4, borderColor: 'error.main', py: 1, px: 2, mb: 3 }}>
                        <Typography variant="body2" color="text.secondary" noWrap>
                          Recurring Clients
                        </Typography>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Grid container spacing={2}>
                    <Grid size={6}>
                      <Box sx={{ borderLeft: 4, borderColor: 'warning.main', py: 1, px: 2, mb: 3 }}>
                        <Typography variant="body2" color="text.secondary" noWrap>
                          Pageviews
                        </Typography>
                    ...
                    <Grid size={6}>
                      <Box sx={{ borderLeft: 4, borderColor: 'success.main', py: 1, px: 2, mb: 3 }}>
                        <Typography variant="body2" color="text.secondary" noWrap>
                          Organic
                        </Typography>
