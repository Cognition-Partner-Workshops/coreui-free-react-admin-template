            ...
            <DocsExample href="components/tooltip">
              <Typography color="text.secondary">
                ...
                <Tooltip title="Tooltip text">
                  <Link sx={{ cursor: 'pointer', mx: 0.5 }}> you probably </Link>
                </Tooltip>
                ...
                american apparel
                <Tooltip title="Tooltip text">
                  <Link sx={{ cursor: 'pointer', mx: 0.5 }}> have a </Link>
                </Tooltip>
                ...
                <Tooltip title="Tooltip text">
                  <Link sx={{ cursor: 'pointer', mx: 0.5 }}> whatever keytar </Link>
                </Tooltip>
                scenester farm-to-table banksy Austin
                <Tooltip title="Tooltip text">
                  <Link sx={{ cursor: 'pointer', mx: 0.5 }}> twitter handle </Link>
                </Tooltip>
