        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Toggle contextual overlays for displaying lists of links and more with the MUI Menu
              component.
            </Typography>
          ...
          <CardContent>
            <DocsExample href="components/dropdown#single-button">
              <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                <Button variant="contained" color="primary" endIcon={<ArrowDropDownIcon />}>
                  Primary
                </Button>
                <Button variant="contained" color="secondary" endIcon={<ArrowDropDownIcon />}>
                  Secondary
                </Button>
                <Button variant="contained" color="success" endIcon={<ArrowDropDownIcon />}>
                  Success
                </Button>
                <Button variant="contained" color="error" endIcon={<ArrowDropDownIcon />}>
                  Danger
                </Button>
                <Button variant="contained" color="warning" endIcon={<ArrowDropDownIcon />}>
                  Warning
                </Button>
                <Button variant="contained" color="info" endIcon={<ArrowDropDownIcon />}>
                  Info
                </Button>
              </Box>
            </DocsExample>
          ...
          <CardContent>
            <DocsExample href="components/dropdown#sizing">
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                <Button variant="contained" size="large" endIcon={<ArrowDropDownIcon />}>
                  Large
                </Button>
              </Box>
