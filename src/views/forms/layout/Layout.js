    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>Give your forms some structure with form layout options.</Typography>
          ...
          <CardContent>
            <DocsExample href="forms/layout#form-grid">
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}><TextField label="First name" fullWidth /></Grid>
                <Grid item xs={12} md={6}><TextField label="Last name" fullWidth /></Grid>
              </Grid>
            </DocsExample>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <DocsExample href="forms/layout#horizontal-form">
              <Grid container spacing={2} alignItems="center">
                <Grid item xs={12} sm={2}><Typography>Email</Typography></Grid>
                <Grid item xs={12} sm={10}><TextField type="email" fullWidth /></Grid>
                <Grid item xs={12} sm={2}><Typography>Password</Typography></Grid>
                <Grid item xs={12} sm={10}><TextField type="password" fullWidth /></Grid>
              </Grid>
            </DocsExample>
          </CardContent>
        </Card>
