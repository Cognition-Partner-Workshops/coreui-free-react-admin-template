    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>Use our custom range inputs for consistent cross-browser styling and built-in customization.</Typography>
