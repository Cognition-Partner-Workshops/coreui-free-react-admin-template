    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>Create beautifully simple form labels that float over your input fields.</Typography>
        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <DocsExample href="forms/floating-labels#readonly-plaintext">
              <TextField label="Input" defaultValue="Readonly input" InputProps={{ readOnly: true }} variant="outlined" fullWidth />
            </DocsExample>
          </CardContent>
        </Card>
      </Grid>
